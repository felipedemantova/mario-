...
<html lang="pt-br">
	...
	<body><a href="cadastroCandidatos.php" class="animated-button1">
  <span></span>
  <span></span>
  <span></span>
  <span></span>
...
<a href="exibe_cadastro.php" class="animated-button1">
  ...
  Listar
		...
		$busca = $_POST['palavra'];
		$result_carrouses = "SELECT * FROM candidato WHERE nome like '$busca%' OR CPF like '$busca%' ORDER BY nome DESC LIMIT $inicio, $qnt_result_pg";
		$busca_query = mysqli_query($conn, $result_carrouses);

	   if (empty($busca_query)) {
		   echo "Nenhum registro encontrado.";
	   }

		while($row_carrouses = mysqli_fetch_assoc($busca_query)){
			echo "cod_candidato: " . $row_carrouses['cod_candidato'] . "<br>";
			...
			echo "<button onclick=\"location.href='proc_apagar_usuario.php?cod_candidato=" . $row_carrouses['cod_candidato'] . "'\">Apagar</button><br><hr>";
		}
